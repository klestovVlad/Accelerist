...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        usersControllerUpdateProfile: async (updateUserDto: UpdateUserDto, options: any = {}): Promise<RequestArgs> => {
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async usersControllerAvatarUpload(file: any, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.usersControllerAvatarUpload(file, options);
         ...
         * @throws {RequiredError}
         */
        async usersControllerFindById(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async usersControllerUpdateProfile(updateUserDto: UpdateUserDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const UserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        usersControllerAvatarUpload(file: any, options?: any): AxiosPromise<void> {
            return localVarFp.usersControllerAvatarUpload(file, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get current user
...
export class UserApi extends BaseAPI {
     ...
     * @memberof UserApi
     */
    public usersControllerAvatarUpload(requestParameters: UserApiUsersControllerAvatarUploadRequest, options?: any) {
        return UserApiFp(this.configuration).usersControllerAvatarUpload(requestParameters.file, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public usersControllerFindById(options?: any) {
        return UserApiFp(this.configuration).usersControllerFindById(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof UserApi
     */
    public usersControllerUpdateProfile(requestParameters: UserApiUsersControllerUpdateProfileRequest, options?: any) {
        return UserApiFp(this.configuration).usersControllerUpdateProfile(requestParameters.updateUserDto, options).then((request) => request(this.axios, this.basePath));
    }
}
