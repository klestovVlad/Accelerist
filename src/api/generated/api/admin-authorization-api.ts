...
export const AdminAuthorizationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async authControllerFindById(options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
 ...
 * @export
 */
export const AdminAuthorizationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
...
export class AdminAuthorizationApi extends BaseAPI {
    ...
    public authControllerFindById(options?: any) {
        return AdminAuthorizationApiFp(this.configuration).authControllerFindById(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AdminAuthorizationApi
     */
    public authControllerSignIn(requestParameters: AdminAuthorizationApiAuthControllerSignInRequest, options?: any) {
        return AdminAuthorizationApiFp(this.configuration).authControllerSignIn(requestParameters.signInDto, options).then((request) => request(this.axios, this.basePath));
    }
}
