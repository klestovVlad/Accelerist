...
export const AuthorizationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        authControllerChangePassword: async (passwordChangeDto: PasswordChangeDto, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        authControllerChangePasswordCallback: async (passwordChangeDto: PasswordChangeDto, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'passwordChangeDto' is not null or undefined
            assertParamExists('authControllerChangePasswordCallback', 'passwordChangeDto', passwordChangeDto)
         ...
         * @throws {RequiredError}
         */
        authControllerGetSignedUrl: async (awsKeyDto: AwsKeyDto, options: any = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(awsKeyDto, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        authControllerResetPassword: async (passwordResetDto: PasswordResetDto, options: any = {}): Promise<RequestArgs> => {
...
export const AuthorizationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async authControllerChangePassword(passwordChangeDto: PasswordChangeDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerChangePassword(passwordChangeDto, options);
         ...
         * @throws {RequiredError}
         */
        async authControllerChangePasswordCallback(passwordChangeDto: PasswordChangeDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerChangePasswordCallback(passwordChangeDto, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async authControllerGetSignedUrl(awsKeyDto: AwsKeyDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerGetSignedUrl(awsKeyDto, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async authControllerResetPassword(passwordResetDto: PasswordResetDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerResetPassword(passwordResetDto, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async authControllerSignIn(signInDto: SignInDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async authControllerSignUp(signUpDto: SignUpDto, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const AuthorizationApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        authControllerChangePassword(passwordChangeDto: PasswordChangeDto, options?: any): AxiosPromise<void> {
            return localVarFp.authControllerChangePassword(passwordChangeDto, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Callback after password changed
         ...
         * @throws {RequiredError}
         */
        authControllerChangePasswordCallback(passwordChangeDto: PasswordChangeDto, options?: any): AxiosPromise<void> {
            return localVarFp.authControllerChangePasswordCallback(passwordChangeDto, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {AwsKeyDto} awsKeyDto 
        ...
        authControllerGetSignedUrl(awsKeyDto: AwsKeyDto, options?: any): AxiosPromise<void> {
            return localVarFp.authControllerGetSignedUrl(awsKeyDto, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Send cheange password email
         ...
         * @throws {RequiredError}
         */
        authControllerResetPassword(passwordResetDto: PasswordResetDto, options?: any): AxiosPromise<void> {
            return localVarFp.authControllerResetPassword(passwordResetDto, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Authorization users
...
export class AuthorizationApi extends BaseAPI {
     ...
     */
    public authControllerChangePassword(requestParameters: AuthorizationApiAuthControllerChangePasswordRequest, options?: any) {
        return AuthorizationApiFp(this.configuration).authControllerChangePassword(requestParameters.passwordChangeDto, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AuthorizationApi
     */
    public authControllerChangePasswordCallback(requestParameters: AuthorizationApiAuthControllerChangePasswordCallbackRequest, options?: any) {
        return AuthorizationApiFp(this.configuration).authControllerChangePasswordCallback(requestParameters.passwordChangeDto, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AuthorizationApi
     */
    public authControllerGetSignedUrl(requestParameters: AuthorizationApiAuthControllerGetSignedUrlRequest, options?: any) {
        return AuthorizationApiFp(this.configuration).authControllerGetSignedUrl(requestParameters.awsKeyDto, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AuthorizationApi
     */
    public authControllerResetPassword(requestParameters: AuthorizationApiAuthControllerResetPasswordRequest, options?: any) {
        return AuthorizationApiFp(this.configuration).authControllerResetPassword(requestParameters.passwordResetDto, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AuthorizationApi
     */
    public authControllerSignIn(requestParameters: AuthorizationApiAuthControllerSignInRequest, options?: any) {
        return AuthorizationApiFp(this.configuration).authControllerSignIn(requestParameters.signInDto, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AuthorizationApi
     */
    public authControllerSignUp(requestParameters: AuthorizationApiAuthControllerSignUpRequest, options?: any) {
        return AuthorizationApiFp(this.configuration).authControllerSignUp(requestParameters.signUpDto, options).then((request) => request(this.axios, this.basePath));
    }
}
